    ...
    return (
        <div className="min-h-screen flex flex-col bg-[var(--color-abyss)] text-[var(--color-bright-gray)] font-sans antialiased">
            <Head>
                ...
                <meta
                    name="description"
                    content={description || "Programming tutorials"}
                />
                <meta property="og:title" content={title || "DevBlog"} />
                <meta property="og:description" content={description || ""} />
                <meta
                    property="og:image"
                    content={image || `${BASE}/og-default.png`}
                />
            ...
            <header className="sticky top-0 z-50 bg-[var(--color-abyss)]/80 backdrop-blur-md border-b border-[var(--color-graphite)]/50">
                ...
                <nav className="relative max-w-[1120px] mx-auto px-8 sm:px-12 lg:px-16 py-5 flex items-center justify-between z-10">
                    <div className="flex items-center gap-3">
                        ...
                        <div className="w-8 h-8 rounded-[8px] bg-gradient-to-br from-[var(--color-amethyst)] to-[#581c87] shadow-[0_0_15px_rgba(124,58,237,0.3)] flex items-center justify-center border border-[#a78bfa]/30">
                            <span className="text-[var(--color-white)] font-bold text-lg leading-none drop-shadow-md">
                                D
                            </span>
                        </div>
                        <Link
                            href="/"
                            className="font-bold text-xl text-[var(--color-bright-gray)] tracking-tight"
                        >
                            DevBlog
                        </Link>
                    </div>
                    ...
                    <div className="hidden md:flex gap-12 text-[15px] text-[var(--color-medium-gray)] font-bold">
                        <Link
                            href="/blog"
                            className="relative group hover:text-[var(--color-bright-gray)] py-1 transition-colors duration-200"
                        >
                            Articles
                ...
                <div
                    className={`md:hidden overflow-hidden transition-all duration-300 ease-in-out bg-[var(--color-abyss)]/95 backdrop-blur-xl ${isMobileMenuOpen ? "max-h-[400px] opacity-100 border-t border-[var(--color-graphite)]/50 shadow-[0_10px_30px_rgba(0,0,0,0.5)]" : "max-h-0 opacity-0"}`}
                >
                    <div className="flex flex-col px-8 py-6 space-y-6">
                        <Link
                            href="/blog"
                            onClick={() => setIsMobileMenuOpen(false)}
                            className="text-[18px] text-[var(--color-bright-gray)] font-bold hover:text-[var(--color-lavender)] transition-colors"
                        >
                            Articles
                        </Link>
                        <Link
            ...
            <div className="max-w-[1120px] mx-auto w-full px-8 sm:px-12 lg:px-16 mb-16">
                <div className="bg-[var(--color-surface)] rounded-xl border border-[var(--color-graphite)] p-4 shadow-[var(--shadow-subtle)]">
                    <div className="text-[10px] text-[var(--color-muted-gray)] uppercase tracking-widest mb-2 text-center">
                        Advertisement
                    </div>
                ...
                <div className="relative max-w-[1120px] mx-auto px-8 sm:px-12 lg:px-16 z-10">
                        ...
                        <div className="col-span-1 sm:col-span-2 md:col-span-2">
                            <div className="flex items-center gap-3 mb-6">
                                <div className="w-8 h-8 md:w-10 md:h-10 rounded-[8px] bg-gradient-to-br from-[var(--color-amethyst)] to-[#581c87] shadow-[0_0_15px_rgba(124,58,237,0.3)] flex items-center justify-center border border-[#a78bfa]/30">
                                    <span className="text-[var(--color-white)] font-bold text-lg md:text-xl leading-none drop-shadow-md">
                                        D
                                    </span>
                                </div>
                                <span className="font-bold text-xl md:text-2xl text-[var(--color-bright-gray)] tracking-tight">
                                    DevBlog
                                </span>
                            </div>
                            <p className="text-[var(--color-medium-gray)] text-[15px] md:text-[16px] leading-[1.6] max-w-sm">
                                A crystalline knowledge vault. We explore the
                                latest programming guides, deep architecture
                                breakdowns, and deliver honest reviews of the
                                best developer tools.
                            </p>
                        </div>

                        <div className="col-span-1">
                            <h3 className="text-[var(--color-amethyst)] font-bold mb-4 sm:mb-6 text-[14px] sm:text-[13px] uppercase tracking-[0.15em] opacity-90">
                                Resources
                            </h3>
                            <ul className="space-y-4">
                                <li>
                                    <Link
                                        href="/blog"
                                        className="relative group inline-block text-[var(--color-medium-gray)] hover:text-[var(--color-bright-gray)] text-[15px] transition-colors py-0.5"
                                    >
                                        All Articles
                    ...
                    <div className="pt-8 border-t border-[var(--color-graphite)]/50 flex flex-col md:flex-row justify-between items-center gap-6">
                        <p className="text-[var(--color-muted-gray)] text-[13px] text-center md:text-left font-medium">
                            &copy; {new Date().getFullYear()} DevBlog. Built
                            with precision and clarity.
                        </p>
                        <div className="flex flex-wrap justify-center gap-6">
                            <Link
                                href="/privacy"
                                className="relative group inline-block text-[var(--color-muted-gray)] hover:text-[var(--color-medium-gray)] text-[13px] font-medium transition-colors"
                            >
                                Privacy Policy
